...
import static com.reprivata.cotstrongswan.logic.VpnBroadcastReceiver.ACTION_DISCONNECT;
import com.reprivata.cotstrongswan.data.VpnProfile;
import com.reprivata.cotstrongswan.data.VpnProfile.SelectedAppsHandling;
import com.reprivata.cotstrongswan.data.VpnType;
import com.reprivata.cotstrongswan.data.VpnType.VpnTypeFeature;
import com.reprivata.cotstrongswan.logic.VpnStateService.ErrorState;
import com.reprivata.cotstrongswan.logic.VpnStateService.State;
import com.reprivata.cotstrongswan.logic.imc.ImcState;
import com.reprivata.cotstrongswan.logic.imc.RemediationInstruction;
import com.reprivata.cotstrongswan.utils.Constants;
import com.reprivata.cotstrongswan.utils.IPRange;
import com.reprivata.cotstrongswan.utils.IPRangeSet;
import com.reprivata.cotstrongswan.utils.SettingsWriter;
import com.reprivata.cotstrongswan.utils.Utils;
...
public class CharonVpnService extends VpnService implements Runnable, VpnStateService.VpnStateListener {
    ...
    public static final String DISCONNECT_ACTION = "com.reprivata.cotstrongswan.CharonVpnService.DISCONNECT";
    private static final String NOTIFICATION_CHANNEL = "com.reprivata.cotstrongswan.CharonVpnService.VPN_STATE_NOTIFICATION";
        ...
        if (intent != null) {
           ...
           if (VPN_SERVICE_ACTION.equals(intent.getAction())||!DISCONNECT_ACTION.equals(intent.getAction())) {
                ...
                if (bundle != null) {
                    ...
                    profile.setUserCertificateAlias(bundle.getString("UserCert"));
                    profile.setCertificateAlias(bundle.getString("CaCert"));
                    profile.setMTU(bundle.getInt("MTU"));
                    profile.setEspProposal("aes256gcm128-ecp384");
                    profile.setIkeProposal("aes256gcm128-sha384-prfsha384-ecp384");
    ...
    private Notification buildNotification(boolean publicVersion) {
        ...
        Intent intent = new Intent("com.reprivata.cotconnect.Launch");
...
//                    builder.setSmallIcon(R.drawable.ic_notification_connecting);\
                ...
                case CONNECTED:
                    ...
                    // Create intent for Disconnect button. The BroadcastReceiver class listens for the Disconnect intent.
                    Intent disconnectIntent = new Intent(this, VpnBroadcastReceiver.class);
                    disconnectIntent.setAction(ACTION_DISCONNECT);

                    PendingIntent pending =
                            PendingIntent.getBroadcast(this, 0, disconnectIntent, 0);
                    builder.addAction(androidx.appcompat.R.drawable.abc_ic_menu_cut_mtrl_alpha, "Disconnect", pending);
