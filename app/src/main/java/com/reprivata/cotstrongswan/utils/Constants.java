...
package com.reprivata.cotstrongswan.utils;
...
public final class Constants
{
     ...
     */
    public static final String VPN_PROFILES_CHANGED = "com.reprivata.cotstrongswan.VPN_PROFILES_CHANGED";

    /**
     * Used in the intent above to notify about edits or inserts of a VPN profile (long)
     */
    public static final String VPN_PROFILES_SINGLE = "com.reprivata.cotstrongswan.VPN_PROFILES_SINGLE";

    /**
     * Used in the intent above to notify about the deletion of multiple VPN profiles (array of longs)
     */
    public static final String VPN_PROFILES_MULTIPLE = "com.reprivata.cotstrongswan.VPN_PROFILES_MULTIPLE";
